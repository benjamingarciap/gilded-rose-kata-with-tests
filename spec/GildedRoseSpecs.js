describe("gildedRose shop manager", function () {
    ...
    it("decreases the quality and the sellIn of the products twice as fast when we have passed the sellIn date", function () {
    ...
    it("the Quality of an item is never negative", function () {
        items.push(new Item("+5 Dexterity Vest", 3, 0));
    ...
    it("decreases the quality of Conjured items twice as fast", function () {
